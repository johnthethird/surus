  ...
  module Hstore
    class Serializer
      ...
      def load(string)
        ...
        # JRuby/jdbc all of a sudden started returning an hstore col as a Java::JavaUtil::HashMap instead of a String, like MRI does.
        return string unless string.is_a?(String) or (RUBY_ENGINE == 'jruby' and string.is_a?(Java::JavaUtil::HashMap))

        # MRI returns hstore col as String
        ...
        elsif (RUBY_ENGINE == 'jruby' and string.is_a?(Java::JavaUtil::HashMap))
          # jruby returns a HashMap
